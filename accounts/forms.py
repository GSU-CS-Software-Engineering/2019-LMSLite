...
class ProfessorAdminChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Professor
        fields = ('email', 'password', 'courses', 'active', 'admin')
...
class StudentAdminChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Student
        fields = ('email', 'password', 'courses', 'active')
...
class ProfessorChangeForm(forms.ModelForm):
    """A form for updating users. Includes all the fields on
    the user, but replaces the password field with admin's
    password hash display field.
    """
