...
function quizEditPageLoad(ddid) {
    ...
    var y = document.querySelectorAll("select[id*=id_Question" + "Answer").length;
    ...
    for (var i = 0; i < x; i++) {
        ...
        for (var i = 0; i < y; i++) {
            var t = document.getElementById("id_Question" + i + "type").onselect;
            if(t === "MC"){
                var radio = document.createElement("input");
                radio.setAttribute("type", "radio");
                radio.setAttribute("name", "name");
                radio.setAttribute("value", "radio");
                radio.setAttribute("id", "id_radio" + i);
                radio.insertBefore(radio, document.getElementById("id_Question" + i + "Answer" + count));
                count++;
            }
        }
